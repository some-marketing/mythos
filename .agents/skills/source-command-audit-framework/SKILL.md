---
name: source-command-audit-framework
description: "Validate framework structure and references"
---

# /audit-framework

Canonical authority: `instructions/canonical/commands/audit-framework.yaml`. Read that file at execution time; this projection never copies or overrides its behavioral body.
