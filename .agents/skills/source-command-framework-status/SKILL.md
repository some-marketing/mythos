---
name: source-command-framework-status
description: "Check framework progress and remaining steps"
---

# /framework-status

Canonical authority: `instructions/canonical/commands/framework-status.yaml`. Read that file at execution time; this projection never copies or overrides its behavioral body.
