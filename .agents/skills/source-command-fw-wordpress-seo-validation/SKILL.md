---
name: source-command-fw-wordpress-seo-validation
description: "Run Seo Validation — Playwright-based pre-launch SEO validation crawl for WordPress sites"
---

# /fw-wordpress-seo-validation

Canonical authority: `instructions/canonical/commands/fw-wordpress-seo-validation.yaml`. Read that file at execution time; this projection never copies or overrides its behavioral body.
