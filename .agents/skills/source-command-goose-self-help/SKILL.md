---
name: source-command-goose-self-help
description: "Goose self-reference command: inspect the local public Goose archive before answering Goose tooling questions"
---

# /goose-self-help

Canonical authority: `instructions/canonical/commands/goose-self-help.yaml`. Read that file at execution time; this projection never copies or overrides its behavioral body.
