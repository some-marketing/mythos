---
name: source-command-improve-framework
description: "Improve framework based on run outputs"
---

# /improve-framework

Canonical authority: `instructions/canonical/commands/improve-framework.yaml`. Read that file at execution time; this projection never copies or overrides its behavioral body.
