---
name: source-command-project-status
description: "Report project progression"
---

# /project-status

Canonical authority: `instructions/canonical/commands/project-status.yaml`. Read that file at execution time; this projection never copies or overrides its behavioral body.
