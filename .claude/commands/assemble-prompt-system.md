...
- Apply required doc updates directly in tools/codex/prompt-system/ and related planning docs.
...
- Validate the result: parse tools/codex/prompt-system/manifest.json, confirm every prompt-pack path referenced by the master run order exists, run npm run manifest:sync and npm run instructions:validate if command or canonical surfaces changed.
</process>
