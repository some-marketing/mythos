...
- Do not run multiple write-owning workers against overlapping `_dev/reports/` or `_dev/prompts/` files.
...
- `_dev/prompts/claude-prompt-pack-master-loop-closure.md`
- `_dev/prompts/claude-prompt-pack-operational-loop-closure.md`
- `whats-next.md`
