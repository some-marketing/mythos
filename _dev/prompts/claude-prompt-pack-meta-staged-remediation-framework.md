...
1. `_dev/prompts/claude-master-run-order.md` is the current source of truth for stage ordering.
2. `_dev/prompts/claude-prompt-pack-semantic-verification.md` remains the first concrete stage to automate.
...
- `_dev/prompts/claude-prompt-pack-semantic-verification.md`
...
- `_dev/prompts/claude-health-remediation-playbook.md`
- `_dev/prompts/claude-prompt-pack-semantic-verification.md`
- `_dev/prompts/claude-prompt-pack-project-health-alignment.md`
- `_dev/prompts/claude-prompt-pack-candidate-replay-hardening.md`
- `_dev/prompts/claude-prompt-pack-semantic-output-audit.md`
