---
name: guild-deliverables-presentation-review-presentation-review
description: "Cross-reference audit of client presentations against project plan documents, screenshots, and errata"
---

Framework lineage: `frameworks/deliverables/presentation-review`. Read its `manifest.json` and `guardrails.md` before execution. Source helper: `frameworks/deliverables/presentation-review/.claude/skills/presentation-review/SKILL.md`.
