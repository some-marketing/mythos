---
name: guild-deliverables-scope-verification-scope-verification
...
Framework lineage: `frameworks/deliverables/scope-verification`. Read its `manifest.json` and `guardrails.md` before execution. Source helper: `frameworks/deliverables/scope-verification/.claude/skills/scope-verification/SKILL.md`.
