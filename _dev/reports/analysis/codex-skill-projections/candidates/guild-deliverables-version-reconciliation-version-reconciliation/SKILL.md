---
name: guild-deliverables-version-reconciliation-version-reconciliation
...
Framework lineage: `frameworks/deliverables/version-reconciliation`. Read its `manifest.json` and `guardrails.md` before execution. Source helper: `frameworks/deliverables/version-reconciliation/.claude/skills/version-reconciliation/SKILL.md`.
