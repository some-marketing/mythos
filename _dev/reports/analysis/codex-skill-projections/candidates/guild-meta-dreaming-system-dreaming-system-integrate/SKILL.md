---
name: guild-meta-dreaming-system-dreaming-system-integrate
description: "Integrate a deterministic dreaming engine into the system's session lifecycle"
---

Framework lineage: `frameworks/meta/dreaming-system`. Read its `manifest.json` and `guardrails.md` before execution. Source helper: `frameworks/meta/dreaming-system/.claude/skills/dreaming-system/integrate/SKILL.md`.
