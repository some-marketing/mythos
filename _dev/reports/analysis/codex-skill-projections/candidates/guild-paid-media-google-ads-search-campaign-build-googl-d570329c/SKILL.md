---
name: guild-paid-media-google-ads-search-campaign-build-googl-d570329c
description: "Build a new Google Ads Search campaign end-to-end: evidence intake, account structure, bidding and budget, keyword and match-type plan, RSA and assets, and measurement and launch — produced as a preview-approve-push bundle."
---

Framework lineage: `frameworks/paid-media/google-ads-search-campaign-build`. Read its `manifest.json` and `guardrails.md` before execution. Source helper: `frameworks/paid-media/google-ads-search-campaign-build/.claude/skills/google-ads-search-campaign-build/SKILL.md`.
