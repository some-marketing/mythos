---
name: guild-project-management-dart-collaboration-dart-collaboration
description: "Abstract task creation and collaboration framework using Dart as human frontend and git workspace repos as LLM-consumable backend"
---

Framework lineage: `frameworks/project-management/dart-collaboration`. Read its `manifest.json` and `guardrails.md` before execution. Source helper: `frameworks/project-management/dart-collaboration/.claude/skills/dart-collaboration/SKILL.md`.
