---
name: guild-project-management-feedback-to-tasks-feedback-to-tasks
...
Framework lineage: `frameworks/project-management/feedback-to-tasks`. Read its `manifest.json` and `guardrails.md` before execution. Source helper: `frameworks/project-management/feedback-to-tasks/.claude/skills/feedback-to-tasks/SKILL.md`.
