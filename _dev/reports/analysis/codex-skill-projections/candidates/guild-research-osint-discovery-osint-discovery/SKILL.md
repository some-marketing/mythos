---
name: guild-research-osint-discovery-osint-discovery
description: "Route bounded public-source discovery across target types."
---

Framework lineage: `frameworks/research/osint-discovery`. Read its `manifest.json` and `guardrails.md` before execution. Source helper: `frameworks/research/osint-discovery/.claude/skills/osint-discovery/SKILL.md`.
