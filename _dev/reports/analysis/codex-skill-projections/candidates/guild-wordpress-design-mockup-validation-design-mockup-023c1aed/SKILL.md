---
name: guild-wordpress-design-mockup-validation-design-mockup-023c1aed
...
Framework lineage: `frameworks/wordpress/design-mockup-validation`. Read its `manifest.json` and `guardrails.md` before execution. Source helper: `frameworks/wordpress/design-mockup-validation/.claude/skills/design-mockup-validation/SKILL.md`.
