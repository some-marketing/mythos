---
name: guild-wordpress-design-research-design-research-site-audit
description: "Performs UX, SEO, and structural analysis of external websites via Playwright MCP. Captures screenshots, DOM structure, schema markup, meta tags, filter patterns, and product/listing card layouts. Produces per-site evidence + cross-site comparison. Use for competitive analysis, auditing client sites, or benchmarking."
---

Framework lineage: `frameworks/wordpress/design-research`. Read its `manifest.json` and `guardrails.md` before execution. Source helper: `frameworks/wordpress/design-research/.claude/skills/design-research/site-audit/SKILL.md`.
