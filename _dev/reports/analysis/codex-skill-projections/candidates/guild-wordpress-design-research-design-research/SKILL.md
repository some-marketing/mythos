---
name: guild-wordpress-design-research-design-research
description: "Pre-build design research, competitive site analysis, and design mockup creation for web development projects"
---

Framework lineage: `frameworks/wordpress/design-research`. Read its `manifest.json` and `guardrails.md` before execution. Source helper: `frameworks/wordpress/design-research/.claude/skills/design-research/SKILL.md`.
