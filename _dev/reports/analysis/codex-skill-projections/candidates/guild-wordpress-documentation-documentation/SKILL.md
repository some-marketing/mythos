---
name: guild-wordpress-documentation-documentation
description: "Client-facing WordPress admin documentation via MCP browser walkthroughs with Notion output"
---

Framework lineage: `frameworks/wordpress/documentation`. Read its `manifest.json` and `guardrails.md` before execution. Source helper: `frameworks/wordpress/documentation/.claude/skills/documentation/SKILL.md`.
