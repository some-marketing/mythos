---
name: guild-wordpress-page-cro-page-cro
description: "Multi-phase conversion rate optimization audit for marketing pages: value proposition, CTA analysis, trust signals, friction assessment, and A/B experiment design"
---

Framework lineage: `frameworks/wordpress/page-cro`. Read its `manifest.json` and `guardrails.md` before execution. Source helper: `frameworks/wordpress/page-cro/.claude/skills/page-cro/SKILL.md`.
