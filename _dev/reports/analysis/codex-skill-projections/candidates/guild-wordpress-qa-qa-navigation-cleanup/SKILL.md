---
name: guild-wordpress-qa-qa-navigation-cleanup
description: "Repository hygiene pass — reduces duplicate docs, archives legacy material, leaves deprecation stubs, updates references, and enforces safe ignore rules for exports/PII. Use when the repository has accumulated duplicate or outdated documentation that hinders navigation."
---

Framework lineage: `frameworks/wordpress/qa`. Read its `manifest.json` and `guardrails.md` before execution. Source helper: `frameworks/wordpress/qa/.claude/skills/qa/navigation-cleanup/SKILL.md`.
