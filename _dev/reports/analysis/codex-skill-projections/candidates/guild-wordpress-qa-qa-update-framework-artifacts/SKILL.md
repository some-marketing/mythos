---
name: guild-wordpress-qa-qa-update-framework-artifacts
...
Framework lineage: `frameworks/wordpress/qa`. Read its `manifest.json` and `guardrails.md` before execution. Source helper: `frameworks/wordpress/qa/.claude/skills/qa/update-framework-artifacts/SKILL.md`.
