---
name: guild-wordpress-seo-audit-seo-audit
description: "Multi-phase SEO audit for WordPress sites: technical, on-page, content quality, and prioritized action plan"
---

Framework lineage: `frameworks/wordpress/seo-audit`. Read its `manifest.json` and `guardrails.md` before execution. Source helper: `frameworks/wordpress/seo-audit/.claude/skills/seo-audit/SKILL.md`.
