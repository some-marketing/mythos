---
name: guild-wordpress-seo-validation-seo-validation
...
Framework lineage: `frameworks/wordpress/seo-validation`. Read its `manifest.json` and `guardrails.md` before execution. Source helper: `frameworks/wordpress/seo-validation/.claude/skills/seo-validation/SKILL.md`.
