---
name: source-command-capture-status
description: "Report capture readiness and missing fields"
---

# /capture-status

Canonical authority: `instructions/canonical/commands/capture-status.yaml`. Read that file at execution time; this projection never copies or overrides its behavioral body.
