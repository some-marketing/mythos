---
name: source-command-normalize-capture
description: "Validate and normalize a capture bundle"
---

# /normalize-capture

Canonical authority: `instructions/canonical/commands/normalize-capture.yaml`. Read that file at execution time; this projection never copies or overrides its behavioral body.
