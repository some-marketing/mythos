---
name: source-command-owl
description: "Human-friendly alias for orchestrate-loop: Observe, Weigh, Loop"
---

# /owl

Canonical authority: `instructions/canonical/commands/owl.yaml`. Read that file at execution time; this projection never copies or overrides its behavioral body.
