---
name: source-command-plans
description: "Render the local Mythos plan visibility dashboard"
---

# /plans

Canonical authority: `instructions/canonical/commands/plans.yaml`. Read that file at execution time; this projection never copies or overrides its behavioral body.
