---
name: source-command-scaffold-framework
description: "Scaffold a framework candidate from captures"
---

# /scaffold-framework

Canonical authority: `instructions/canonical/commands/scaffold-framework.yaml`. Read that file at execution time; this projection never copies or overrides its behavioral body.
