...
// strategy.
//
// G-ISO: every path here is caller-supplied and scoped under a sandbox root
// this module creates -- no shared directory, module, or process with
...
// One verb set for this tier -- deliberately smaller than cat-world's 12
// verbs, because there is no cross-mind negotiation primitive needed (there
...
// later) work the same way. Each hive's sandbox is independent (G-ISO);
