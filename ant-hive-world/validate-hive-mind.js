...
//
// Deliberately minimal relative to tools/soul-space/validate-soul-space.js:
// this schema does not claim an immutable true-self layer, so there is no
// content-hash recomputation here. What IS checked: schema shape, and (for
// seed documents specifically) that no pre-loaded instinct/behavior content
// exists at creation -- per the operator's "let them figure it out through
// experience" resolution.
//
// Spec: _dev/concepts/ant-hive-world/context/hive-mind-schema.md
// Plan: _dev/reports/analysis/task-plans/ant-hive-world__plan.json (S1b)
