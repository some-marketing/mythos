...
//
// Reuses the EXACT tear-free envelope already proven in cat-world's
// poke-world.js / harness-world.js (schema_version, monotonic seq, complete,
// atomic temp+rename) so the write-side discipline is proven, not reinvented.
// The richer payload here (resources/territory/geometry per hive) is new --
// visualizing it in Unreal needs its own mapping-table extension (M1-style),
// which is NOT built yet; this module only proves the Node-side write/read
// discipline. See ant-hive-world__plan.json S2 for the honest scope line.
//
// G-ISO: this file and its state live entirely under tools/ant-hive-world/ and
// a caller-supplied state path -- no import of, or shared module with,
// crow-alien-world's or cat-world's harness code.
...
// reader (this module or, eventually, an Unreal WorldStateReader extension)
