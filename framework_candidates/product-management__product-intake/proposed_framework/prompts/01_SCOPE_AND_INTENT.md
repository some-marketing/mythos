...
Turn an early request into a bounded product-intake question without assuming the requested solution is correct.
...
- Intended users
- Desired outcome
- Constraints and known alternatives
- Any supplied evidence

## Steps

1. Restate the reported problem in observational language.
...
- Initial assumptions and open-question register
