...
A read/review-only workflow that describes a brownfield change as explicit added, modified, and removed requirements with scenarios, dependencies, acceptance criteria, and an independent readiness review.
