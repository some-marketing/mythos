...
Single source of truth for the current top-level Claude prompt-system workflow in `tools/codex/prompt-system/`.
...
All other prompt packs in `tools/codex/prompt-system/` are not co-equal top-level workflows.
