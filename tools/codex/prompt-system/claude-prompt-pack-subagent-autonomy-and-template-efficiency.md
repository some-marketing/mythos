...
- `tools/codex/prompt-system/claude-prompt-pack-subagent-autonomy-and-template-efficiency.md` (this proposal — Track B sections)
...
Read these files first:
- `tools/codex/prompt-system/claude-prompt-pack-subagent-autonomy-and-template-efficiency.md` (this proposal — A1, A2, A7 sections)
...
Read these files first:
- `tools/codex/prompt-system/claude-prompt-pack-subagent-autonomy-and-template-efficiency.md` (this proposal — A3, A5, B5 sections)
...
Read these files first:
- `tools/codex/prompt-system/claude-prompt-pack-subagent-autonomy-and-template-efficiency.md` (this proposal — A4, A8, B6, A6 sections)
- `.claude/skills/execute-framework/workflows/execute.md`
- `.claude/skills/execute-framework/workflows/review.md`
