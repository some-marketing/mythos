...
- `tools/codex/prompt-system/claude-prompt-pack-master-prompt-and-operator-ux-hardening.md`
- `tools/codex/prompt-system/claude-prompt-pack-source-material-qa-and-promotion.md`
...
- Examples:
  ...
  - prompt-system/planning-only changes:
    - parse `tools/codex/prompt-system/manifest.json` if touched
