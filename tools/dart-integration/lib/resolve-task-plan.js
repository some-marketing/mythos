...
/**
 * VENDORED into tools/dart-integration/lib/ for this export: post-plan-comment.js
 * has a hard dependency on resolveTaskPlanPaths() (given a task-id or file path,
 * find the paired plan JSON/MD under a system dir or a per-client plans/
 * directory). The canonical/original location for this file is a separate,
 * out-of-scope planning tree; this is a self-contained copy (fs/path only, no
 * further dependencies) so dart-integration works standalone.
 */
 ...
 * @param {string} clientCode - Client code (e.g. "EXAMPLECOA").
