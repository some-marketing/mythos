...
if (require.main === module) {
  ...
  if (args.includes('--help') || args.includes('-h')) {
    process.stdout.write([
      ...
      '',
      'patron-delta example (account 10151393423266343, ad 6999037446653):',
      '  node edit-creative-text.js \\',
      '    --account 10151393423266343 --ad 6999037446653 \\',
      '    --replace "Antigonish, Port Hawkesbury, Guysborough, and Inverness::Antigonish and Port Hawkesbury" \\',
      '    --replace "Antigonish, Port Hawkesbury, Guysborough & Inverness::Antigonish & Port Hawkesbury" \\',
      '    --dry-run',
      '',
      'Carousel example (drop cards matching "guysborough|inverness"):',
      '  node edit-creative-text.js \\',
      '    --account 10151393423266343 --ad 6999037446853 \\',
      '    --drop-card-matching "guysborough|inverness" \\',
      '    --replace "Antigonish, Port Hawkesbury, Guysborough, and Inverness::Antigonish and Port Hawkesbury" \\',
      '    --dry-run',
      '',
      'Exit codes: 0=success/dry-run, 1=error/abort, 2=input error'
