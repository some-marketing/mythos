# GPU preflight / swap readiness check.
# Run from an elevated PowerShell prompt.
#
# Config (override via env): PREFLIGHT_OUTPUT_DIR

$ErrorActionPreference = "Stop"

$OutputDir = if ($env:PREFLIGHT_OUTPUT_DIR) { $env:PREFLIGHT_OUTPUT_DIR } else { "$PSScriptRoot\..\..\_dev\outputs\gpu-preflight" }
